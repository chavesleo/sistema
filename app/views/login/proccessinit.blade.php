...
<body>
	...
	<div class = "container">
		<div class="wrapper">
			{{ Form::open(array('url' => URL::current(), 'method' => 'post', 'role'=>'form', 'class'=>'form-signin')) }}
				<h3 class="form-signin-heading">Prossiga com o seu e-mail...</h3>
				<hr class="colorgraph">
				<br>
				<input type="email" class="form-control" name="email" placeholder="email@email.com" required="" autofocus="" />
				<br>
				<button class="btn btn-lg btn-primary btn-block" type="Submit">
					<span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;&nbsp;Continuar
				</button>
			{{Form::close()}}
		</div>
	</div>
