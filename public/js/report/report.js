    ...
    datasets : [
        {
            ...
            data : [20,26,35,12,18,45,49,40,15,20,12,7]
        }
    ]
}

var cline = document.getElementById("cline").getContext("2d");
new Chart(cline).Line(lineChartData, { responsive: true });
/****************************** END LINE CHART ********************************/
    ...
    datasets : [
        {
            ...
            data : [130,160,95,205,170,135,200, 125, 140, 150, 144, 122]
        },
        {
           fillColor: "rgba(151,187,205,0.5)",
            ...
            data : [85,90,160,145,180,130,195, 125, 140, 150, 144, 122]
        }
    ]
}

var cbar = document.getElementById("cbar").getContext("2d");
new Chart(cbar).Bar(bdata, { responsive : true });
